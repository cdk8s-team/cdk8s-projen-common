...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProject.addPackageIgnore">addPackageIgnore</a></code> | Adds patterns to be ignored by npm. |
...
##### `with` <a name="with" id="@cdk8s/projen-common.Cdk8sTeamJsiiProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@cdk8s/projen-common.Cdk8sTeamJsiiProject.with.parameter.mixins"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProject.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProject.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | Maximum node version supported by this package. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProject.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@cdk8s/projen-common.Cdk8sTeamJsiiProject.property.biome"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProject.addPackageIgnore">addPackageIgnore</a></code> | Adds patterns to be ignored by npm. |
...
##### `with` <a name="with" id="@cdk8s/projen-common.Cdk8sTeamNodeProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@cdk8s/projen-common.Cdk8sTeamNodeProject.with.parameter.mixins"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProject.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProject.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | Maximum node version supported by this package. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProject.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@cdk8s/projen-common.Cdk8sTeamNodeProject.property.biome"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.with">with</a></code> | Applies one or more mixins to this construct. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.addPackageIgnore">addPackageIgnore</a></code> | Adds patterns to be ignored by npm. |
...
##### `with` <a name="with" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.with.parameter.mixins"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.property.biome">biome</a></code> | <code>projen.javascript.Biome</code> | *No description.* |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | Maximum node version supported by this package. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. |
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProject.property.biome"></a>
...
| <code><a href="#@cdk8s/projen-common.Triage.with">with</a></code> | Applies one or more mixins to this construct. |
| <code><a href="#@cdk8s/projen-common.Triage.postProjectCreation">postProjectCreation</a></code> | Called once, right after `postSynthesize()`, only when the project is created for the first time. |
...
| <code><a href="#@cdk8s/projen-common.Triage.projectCreation">projectCreation</a></code> | Called once, right after `synthesize()`, only when the project is created for the first time. |
...
##### `with` <a name="with" id="@cdk8s/projen-common.Triage.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@cdk8s/projen-common.Triage.with.parameter.mixins"></a>
...
##### `postProjectCreation` <a name="postProjectCreation" id="@cdk8s/projen-common.Triage.postProjectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@cdk8s/projen-common.Triage.postProjectCreation.parameter.initProject"></a>
...
##### `projectCreation` <a name="projectCreation" id="@cdk8s/projen-common.Triage.projectCreation"></a>
...
###### `initProject`<sup>Required</sup> <a name="initProject" id="@cdk8s/projen-common.Triage.projectCreation.parameter.initProject"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.config">config</a></code> | <code>{[ key: string ]: any}</code> | Configuration values available to package scripts at runtime. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.npmProvenance">npmProvenance</a></code> | <code>boolean</code> | Should provenance statements be generated when the package is published. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.npmTrustedPublishing">npmTrustedPublishing</a></code> | <code>boolean</code> | Use trusted publishing for publishing to npmjs.com Needs to be pre-configured on npm.js to work. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.buildWorkflowOptions">buildWorkflowOptions</a></code> | <code>projen.javascript.BuildWorkflowOptions</code> | Options for PR build workflow. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.checkLicenses">checkLicenses</a></code> | <code>projen.javascript.LicenseCheckerOptions</code> | Configure which licenses should be deemed acceptable for use by dependencies. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.tsconfigDevFile">tsconfigDevFile</a></code> | <code>string</code> | The name (and path) of the development tsconfig file. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.typecheckTests">typecheckTests</a></code> | <code>boolean</code> | Type-check the test suite as part of the `test` task. |
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.allowScripts"></a>
...
##### `bunVersion`<sup>Optional</sup> <a name="bunVersion" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.bunVersion"></a>
...
##### `config`<sup>Optional</sup> <a name="config" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.config"></a>
...
##### `npmProvenance`<sup>Optional</sup> <a name="npmProvenance" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.npmProvenance"></a>
...
##### `npmTrustedPublishing`<sup>Optional</sup> <a name="npmTrustedPublishing" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.npmTrustedPublishing"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.bumpPackage"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.biomeOptions"></a>
...
##### `buildWorkflowOptions`<sup>Optional</sup> <a name="buildWorkflowOptions" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.buildWorkflowOptions"></a>
...
##### `checkLicenses`<sup>Optional</sup> <a name="checkLicenses" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.checkLicenses"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.defaultReleaseBranch"></a>
...
##### `typecheckTests`<sup>Optional</sup> <a name="typecheckTests" id="@cdk8s/projen-common.Cdk8sTeamJsiiProjectOptions.property.typecheckTests"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.config">config</a></code> | <code>{[ key: string ]: any}</code> | Configuration values available to package scripts at runtime. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.npmProvenance">npmProvenance</a></code> | <code>boolean</code> | Should provenance statements be generated when the package is published. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.npmTrustedPublishing">npmTrustedPublishing</a></code> | <code>boolean</code> | Use trusted publishing for publishing to npmjs.com Needs to be pre-configured on npm.js to work. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.buildWorkflowOptions">buildWorkflowOptions</a></code> | <code>projen.javascript.BuildWorkflowOptions</code> | Options for PR build workflow. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.checkLicenses">checkLicenses</a></code> | <code>projen.javascript.LicenseCheckerOptions</code> | Configure which licenses should be deemed acceptable for use by dependencies. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.allowScripts"></a>
...
##### `bunVersion`<sup>Optional</sup> <a name="bunVersion" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.bunVersion"></a>
...
##### `config`<sup>Optional</sup> <a name="config" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.config"></a>
...
##### `npmProvenance`<sup>Optional</sup> <a name="npmProvenance" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.npmProvenance"></a>
...
##### `npmTrustedPublishing`<sup>Optional</sup> <a name="npmTrustedPublishing" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.npmTrustedPublishing"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.bumpPackage"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.biomeOptions"></a>
...
##### `buildWorkflowOptions`<sup>Optional</sup> <a name="buildWorkflowOptions" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.buildWorkflowOptions"></a>
...
##### `checkLicenses`<sup>Optional</sup> <a name="checkLicenses" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.checkLicenses"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="@cdk8s/projen-common.Cdk8sTeamNodeProjectOptions.property.defaultReleaseBranch"></a>
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.config">config</a></code> | <code>{[ key: string ]: any}</code> | Configuration values available to package scripts at runtime. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.maxNodeVersion">maxNodeVersion</a></code> | <code>string</code> | The maximum node version supported by this package. Most projects should not use this option. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.minNodeVersion">minNodeVersion</a></code> | <code>string</code> | The minimum node version required by this package to function. Most projects should not use this option. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.npmProvenance">npmProvenance</a></code> | <code>boolean</code> | Should provenance statements be generated when the package is published. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.npmTrustedPublishing">npmTrustedPublishing</a></code> | <code>boolean</code> | Use trusted publishing for publishing to npmjs.com Needs to be pre-configured on npm.js to work. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.nextVersionCommand">nextVersionCommand</a></code> | <code>string</code> | A shell command to control the next version to release. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.releaseEnvironment">releaseEnvironment</a></code> | <code>string</code> | The GitHub Actions environment used for the release. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.releaseWorkflowEnv">releaseWorkflowEnv</a></code> | <code>{[ key: string ]: string}</code> | Build environment variables for release workflows. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.versionrcOptions">versionrcOptions</a></code> | <code>{[ key: string ]: any}</code> | Custom configuration used when creating changelog with commit-and-tag-version package. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.auditDeps">auditDeps</a></code> | <code>boolean</code> | Run security audit on dependencies. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.auditDepsOptions">auditDepsOptions</a></code> | <code>projen.javascript.AuditOptions</code> | Security audit options. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.autoApproveUpgrades">autoApproveUpgrades</a></code> | <code>boolean</code> | Automatically approve deps upgrade PRs, allowing them to be merged by mergify (if configured). |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.biome">biome</a></code> | <code>boolean</code> | Setup Biome. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.biomeOptions">biomeOptions</a></code> | <code>projen.javascript.BiomeOptions</code> | Biome options. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.buildWorkflowOptions">buildWorkflowOptions</a></code> | <code>projen.javascript.BuildWorkflowOptions</code> | Options for PR build workflow. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.checkLicenses">checkLicenses</a></code> | <code>projen.javascript.LicenseCheckerOptions</code> | Configure which licenses should be deemed acceptable for use by dependencies. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.codeCov">codeCov</a></code> | <code>boolean</code> | Define a GitHub workflow step for sending code coverage metrics to https://codecov.io/. |
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.codeCovTokenSecret">codeCovTokenSecret</a></code> | <code>string</code> | Define the secret name for a specified https://codecov.io/ token. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.workflowNodeVersion">workflowNodeVersion</a></code> | <code>string</code> | The node version used in GitHub Actions workflows. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.disableTsconfigDev">disableTsconfigDev</a></code> | <code>boolean</code> | Do not generate a development tsconfig file. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.tsconfigDevFile">tsconfigDevFile</a></code> | <code>string</code> | The name (and path) of the development tsconfig file. |
...
| <code><a href="#@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.typecheckTests">typecheckTests</a></code> | <code>boolean</code> | Type-check the test suite as part of the `test` task. |
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.allowScripts"></a>
...
##### `bunVersion`<sup>Optional</sup> <a name="bunVersion" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.bunVersion"></a>
...
##### `config`<sup>Optional</sup> <a name="config" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.config"></a>
...
##### `npmProvenance`<sup>Optional</sup> <a name="npmProvenance" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.npmProvenance"></a>
...
##### `npmTrustedPublishing`<sup>Optional</sup> <a name="npmTrustedPublishing" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.npmTrustedPublishing"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.pnpmOptions"></a>
...
##### `bumpPackage`<sup>Optional</sup> <a name="bumpPackage" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.bumpPackage"></a>
...
##### `nextVersionCommand`<sup>Optional</sup> <a name="nextVersionCommand" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.nextVersionCommand"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.releaseWorkflowEnv"></a>
...
##### `auditDeps`<sup>Optional</sup> <a name="auditDeps" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.auditDeps"></a>
...
##### `auditDepsOptions`<sup>Optional</sup> <a name="auditDepsOptions" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.auditDepsOptions"></a>
...
##### `biome`<sup>Optional</sup> <a name="biome" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.biome"></a>
...
##### `biomeOptions`<sup>Optional</sup> <a name="biomeOptions" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.biomeOptions"></a>
...
##### `buildWorkflowOptions`<sup>Optional</sup> <a name="buildWorkflowOptions" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.buildWorkflowOptions"></a>
...
##### `checkLicenses`<sup>Optional</sup> <a name="checkLicenses" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.checkLicenses"></a>
...
##### `defaultReleaseBranch`<sup>Optional</sup> <a name="defaultReleaseBranch" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.defaultReleaseBranch"></a>
...
##### `typecheckTests`<sup>Optional</sup> <a name="typecheckTests" id="@cdk8s/projen-common.Cdk8sTeamTypeScriptProjectOptions.property.typecheckTests"></a>
